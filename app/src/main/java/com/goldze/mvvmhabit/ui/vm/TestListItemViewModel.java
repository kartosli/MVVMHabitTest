...
public class TestListItemViewModel extends BaseViewModel {
    public DemoEntity.ItemsEntity entity;
    public Drawable drawableImg;

    public TestListItemViewModel(Context context, DemoEntity.ItemsEntity entity) {
        super(context);
        this.entity = entity;
...
//            Messenger.getDefault().send(TestListItemViewModel.this, NetWorkViewModel.TOKEN_NETWORKVIEWMODEL_DELTE_ITEM);
        }
    });
//    /**
